...
$GET_Id =$_GET['delete'];
$del_query = "DELETE FROM posts WHERE post_id =$GET_Id";
$del_reslut = mysqli_query($con , $del_query);
...
echo "
        <tr>
            ...
            <td>$post_content</td>
             <td><img src='../img/$post_image' height = '50'></td>
            <td>
                <button class='btn btn-blue btn-icon'><a href='edit-post.php?edit=$post_id'>gg</a></button>
            </td>
            <td>
                <button class='btn btn-red btn-icon'><a href='all-post.php?delete=$post_id'> <i data-feather='trash-2'></i> </a></button>
            </td>
        </tr> 
