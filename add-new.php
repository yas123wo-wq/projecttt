...
move_uploaded_file($_FILESl['post_image']['tmp_name'],$des);
$cat_id =$_POST['cat_id'];
$query = "INSERT INTO posts (post_title,post_content,post_image,cat_id) VALUES ('$post_title','$post_content','$post_image', $cat_id)";
...
<html lang="en">
   ...
   <div class="form-group">
                                        ...
                                        <input name="post_content" class="form-control" id="post-title" type="text" placeholder="Post description ..." />
                                    </div>
                                    ...
                                    <button name="add_post" class="btn btn-primary mr-2 my-1" type="submit">Submit now</button>
                                </form>
                            </div>
                        </div>
                    </div>
